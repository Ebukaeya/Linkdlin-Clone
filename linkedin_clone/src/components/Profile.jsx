...
const openDisplay = ()=>{
      ...
      <div className="profileSection">
        ...
        <div className="profileContentWrapper">
          <div className="profilePictureDivFlexContainer">
            ...
            <div>
              <div className="profileImage">
                <img
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTEpOB50Gf-839DMNoHRlYYBAWP0TN73RHsGg&usqp=CAU"
                  style={{
                    width: "154px",
                    height: "154px",
                    objectFit: "cover",
          ...
          <div className="openToWorkSubSection">
            ...
            <div>
            <div className="ti-openwrk">
                <div style={{marginBottom:"-4px"}}><span className="secondSpanOpentoWork"> Share that you're hiring</span> <span> and attract qualified</span></div>
  ...
  <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/>
              ...
              <p className="seeAllDetails">Get started</p></div>
          </div>
        </div>
      </div>
    </>
